<!-- resources/views/receiver_status.blade.php -->
    ...
    <div class="request-container">
        ...
        <div class="table-responsive">
            <table class="request-table">
                        ...
                        <td>
                            @if($request->canEdit())
                                <div class="action-buttons">
                                    <a href="{{ route('receiver.request.edit', $request->id) }}"
                                       class="btn-action btn-edit">Edit</a>
                                    <form action="{{ route('receiver.request.destroy', $request->id) }}"
                                          method="POST">
                                        @csrf
                                        @method('DELETE')
                ...
                @empty
                    <tr>
                        <td colspan="8" class="no-requests">No blood requests found</td>
                    </tr>
                @endforelse
                </tbody>
            </table>
